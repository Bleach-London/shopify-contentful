...
var etag = __webpack_require__(50);
var proxyaddr = __webpack_require__(54);
...
var ms = __webpack_require__(107)
var onFinished = __webpack_require__(16)
...
/* harmony export (immutable) */ __webpack_exports__["default"] = expressApp;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_express__ = __webpack_require__(57);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_express___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_express__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_cors__ = __webpack_require__(121);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_cors___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_cors__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_body_parser__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_body_parser___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_body_parser__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_compression__ = __webpack_require__(123);
...
function expressApp(functionName) {
  ...
  const router = __WEBPACK_IMPORTED_MODULE_0_express___default.a.Router(); // gzip responses

  router.use(__WEBPACK_IMPORTED_MODULE_3_compression___default()()); // Set router base path for local dev

  const routerBasePath = process.env.NODE_ENV === 'dev' ? "/".concat(functionName) : "/.netlify/functions/".concat(functionName, "/");
  /* define routes */

  router.get('/', (req, res) => {
    const html = "\n    <html>\n      <head>\n        <style>\n          body {\n            padding: 30px;\n          }\n        </style>\n      </head>\n      <body>\n        <h1>Express via '".concat(functionName, "' \u2282\u25C9\u203F\u25C9\u3064</h1>\n        <p>I'm using Express running via a <a href='https://www.netlify.com/docs/functions/' target='_blank'>Netlify Function</a>.</p>\n        <p>Choose a route:</p>\n        <div>\n          <a href='/.netlify/functions/").concat(functionName, "/users'>View /users route</a>\n        </div>\n        <div>\n          <a href='/.netlify/functions/").concat(functionName, "/hello'>View /hello route</a>\n        </div>\n        <br/>\n        <br/>\n        <div>\n          <a href='/'>\n            Go back to demo homepage\n          </a>\n        </div>\n        <br/>\n        <br/>\n        <div>\n          <a href='https://github.com/DavidWells/netlify-functions-express' target='_blank'>\n            See the source code on github\n          </a>\n        </div>\n      </body>\n    </html>\n  ");
    res.send(html);
  });
  ...
  app.use(routerBasePath, router); // Apply express middlewares

  router.use(__WEBPACK_IMPORTED_MODULE_1_cors___default()());
  router.use(__WEBPACK_IMPORTED_MODULE_2_body_parser___default.a.json());
  router.use(__WEBPACK_IMPORTED_MODULE_2_body_parser___default.a.urlencoded({
    extended: true
  }));
  return app;
}
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(24).concat(__webpack_require__(35)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
...
var accepts = __webpack_require__(55);
var deprecate = __webpack_require__(1)('express');
...
var compressible = __webpack_require__(125)
var debug = __webpack_require__(0)('compression')
var onHeaders = __webpack_require__(126)
var vary = __webpack_require__(28)
var zlib = __webpack_require__(38)
